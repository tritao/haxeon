...
DEFINE_PRIM(_I32,native_type_kind,_BYTES);
DEFINE_PRIM(_I32,native_type_size,_BYTES);
DEFINE_PRIM(_I32,native_type_pad_struct,_BYTES _I32);
...
DEFINE_PRIM(_I32,native_metadata_validate_debug_files,_BYTES _I32);
DEFINE_PRIM(_I32,native_metadata_validate_function_debug,_BYTES _I32);
...
DEFINE_PRIM(_I32,native_type_virtual_field_count,_BYTES);
