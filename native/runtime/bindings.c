...
DEFINE_PRIM(_BYTES,native_alloc,_I32 _I32);
DEFINE_PRIM(_VOID,native_free,_BYTES);
DEFINE_PRIM(_BOOL,native_is_aligned,_BYTES _I32);
DEFINE_PRIM(_ABSTRACT(native_pointer),native_pointer_owned_from_slot,_ABSTRACT(realtime_bytes) _I32 _BYTES _BYTES _BYTES _BYTES _BOOL);
...
DEFINE_PRIM(_I32,native_runtime_module_call_i32_slot,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_VOID,native_runtime_module_call_void,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_VOID,native_runtime_module_call_void_slot,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_BYTES,native_runtime_module_call_bytes,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_BYTES,native_runtime_module_call_bytes_slot,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_VOID,native_runtime_module_call_bytes1,_ABSTRACT(realtime_module) _I32 _BYTES);
DEFINE_PRIM(_VOID,native_runtime_module_call_bytes1_slot,_ABSTRACT(realtime_module) _I32 _BYTES);
DEFINE_PRIM(_DYN,native_runtime_module_call_closure,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_DYN,native_runtime_module_call_closure_slot,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_I32,native_runtime_module_call_closure_i32,_ABSTRACT(realtime_module) _DYN);
DEFINE_PRIM(_DYN,native_runtime_module_call_object,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_DYN,native_runtime_module_call_object_slot,_ABSTRACT(realtime_module) _I32);
DEFINE_PRIM(_I32,native_runtime_module_call_i32_object,_ABSTRACT(realtime_module) _I32 _DYN);
DEFINE_PRIM(_I32,native_runtime_module_call_i32_object_slot,_ABSTRACT(realtime_module) _I32 _DYN);
DEFINE_PRIM(_I32,native_runtime_module_validate_call,_ABSTRACT(realtime_module) _I32 _I32);
DEFINE_PRIM(_I32,native_runtime_module_validate_call_slot,_ABSTRACT(realtime_module) _I32 _I32);
...
DEFINE_PRIM(_I32,native_runtime_module_debug_hlb_size,_ABSTRACT(realtime_module));
...
DEFINE_PRIM(_ABSTRACT(realtime_jit_code),patch_code,_ABSTRACT(realtime_module) _BYTES _I32 _BYTES);
DEFINE_PRIM(_BOOL,release_code,_ABSTRACT(realtime_jit_code));
DEFINE_PRIM(_I32,code_revision,_ABSTRACT(realtime_jit_code));
...
DEFINE_PRIM(_I32,native_atomic_i32_load,_BYTES _I32);
DEFINE_PRIM(_VOID,native_atomic_i32_store,_BYTES _I32 _I32);
DEFINE_PRIM(_I32,native_atomic_i32_exchange,_BYTES _I32 _I32);
DEFINE_PRIM(_I32,native_atomic_i32_compare_exchange,_BYTES _I32 _I32 _I32);
DEFINE_PRIM(_I32,native_atomic_i32_fetch_add,_BYTES _I32 _I32);
DEFINE_PRIM(_I64,native_atomic_i64_load,_BYTES _I32);
DEFINE_PRIM(_VOID,native_atomic_i64_store,_BYTES _I64 _I32);
DEFINE_PRIM(_I64,native_atomic_i64_exchange,_BYTES _I64 _I32);
DEFINE_PRIM(_I64,native_atomic_i64_compare_exchange,_BYTES _I64 _I64 _I32);
DEFINE_PRIM(_I64,native_atomic_i64_fetch_add,_BYTES _I64 _I32);
DEFINE_PRIM(_BYTES,native_atomic_ptr_load,_BYTES _I32);
DEFINE_PRIM(_VOID,native_atomic_ptr_store,_BYTES _BYTES _I32);
DEFINE_PRIM(_BYTES,native_atomic_ptr_exchange,_BYTES _BYTES _I32);
DEFINE_PRIM(_BYTES,native_atomic_ptr_compare_exchange,_BYTES _BYTES _BYTES _I32);
...
DEFINE_PRIM(_ABSTRACT(haxeon_gc_handle),native_gc_handle_create_owned_raw,_DYN _BYTES);
...
DEFINE_PRIM(_BOOL,native_gc_handle_close,_ABSTRACT(haxeon_gc_handle));
DEFINE_PRIM(_BOOL,native_gc_handle_is_closed,_ABSTRACT(haxeon_gc_handle));
DEFINE_PRIM(_ABSTRACT(haxeon_gc_weak_handle),native_gc_weak_handle_create,_DYN);
DEFINE_PRIM(_DYN,native_gc_weak_handle_get,_ABSTRACT(haxeon_gc_weak_handle));
DEFINE_PRIM(_VOID,native_gc_weak_handle_set,_ABSTRACT(haxeon_gc_weak_handle) _DYN);
DEFINE_PRIM(_BYTES,native_gc_weak_handle_raw,_ABSTRACT(haxeon_gc_weak_handle));
DEFINE_PRIM(_BOOL,native_gc_weak_handle_close,_ABSTRACT(haxeon_gc_weak_handle));
DEFINE_PRIM(_BOOL,native_gc_weak_handle_is_closed,_ABSTRACT(haxeon_gc_weak_handle));
DEFINE_PRIM(_VOID,native_gc_major,);
DEFINE_PRIM(_ABSTRACT(haxeon_gc_stats),native_gc_stats_snapshot,);
DEFINE_PRIM(_I64,native_gc_stats_total_allocated,_ABSTRACT(haxeon_gc_stats));
DEFINE_PRIM(_I64,native_gc_stats_allocation_count,_ABSTRACT(haxeon_gc_stats));
DEFINE_PRIM(_I64,native_gc_stats_heap_bytes,_ABSTRACT(haxeon_gc_stats));
DEFINE_PRIM(_I64,native_gc_stats_collection_count,_ABSTRACT(haxeon_gc_stats));
DEFINE_PRIM(_I64,native_gc_stats_mark_micros,_ABSTRACT(haxeon_gc_stats));
DEFINE_PRIM(_ABSTRACT(hl_mutex),native_mutex_alloc,_BOOL);
DEFINE_PRIM(_VOID,native_mutex_acquire,_ABSTRACT(hl_mutex));
DEFINE_PRIM(_BOOL,native_mutex_try_acquire,_ABSTRACT(hl_mutex));
DEFINE_PRIM(_VOID,native_mutex_release,_ABSTRACT(hl_mutex));
DEFINE_PRIM(_VOID,native_mutex_close,_ABSTRACT(hl_mutex));
DEFINE_PRIM(_ABSTRACT(hl_condition),native_condition_alloc,);
DEFINE_PRIM(_VOID,native_condition_acquire,_ABSTRACT(hl_condition));
DEFINE_PRIM(_BOOL,native_condition_try_acquire,_ABSTRACT(hl_condition));
DEFINE_PRIM(_VOID,native_condition_release,_ABSTRACT(hl_condition));
DEFINE_PRIM(_VOID,native_condition_wait,_ABSTRACT(hl_condition));
DEFINE_PRIM(_BOOL,native_condition_timed_wait,_ABSTRACT(hl_condition) _F64);
DEFINE_PRIM(_VOID,native_condition_signal,_ABSTRACT(hl_condition));
DEFINE_PRIM(_VOID,native_condition_broadcast,_ABSTRACT(hl_condition));
DEFINE_PRIM(_VOID,native_condition_close,_ABSTRACT(hl_condition));
DEFINE_PRIM(_ABSTRACT(haxeon_tls),native_tls_alloc,_BOOL);
DEFINE_PRIM(_DYN,native_tls_get,_ABSTRACT(haxeon_tls));
DEFINE_PRIM(_VOID,native_tls_set,_ABSTRACT(haxeon_tls) _DYN);
DEFINE_PRIM(_VOID,native_tls_clear,_ABSTRACT(haxeon_tls));
DEFINE_PRIM(_VOID,native_tls_close,_ABSTRACT(haxeon_tls));
DEFINE_PRIM(_I32,native_pointer_size,);
DEFINE_PRIM(_VOID,native_metadata_publish_object_prototype,_BYTES);
...
DEFINE_PRIM(_BOOL,native_metadata_module_patch_slots,_BYTES _BYTES _BYTES _I32);
...
DEFINE_PRIM(_ARR,__array_alloc_i64,_I32);
...
DEFINE_PRIM(_ARR,__array_copy_i64,_ARR);
...
DEFINE_PRIM(_ARR,__array_concat_i64,_ARR _ARR);
...
DEFINE_PRIM(_ARR,__array_slice_i64,_ARR _I32 _I32);
...
DEFINE_PRIM(_ARR,__array_splice_i64,_ARR _I32 _I32);
...
DEFINE_PRIM(_I32,__array_index_of_i64,_ARR _I64);
...
DEFINE_PRIM(_BOOL,__array_remove_i64,_ARR _I64);
...
DEFINE_PRIM(_BOOL,__reflect_is_object,_DYN);
...
DEFINE_PRIM(_VOID,__array_reverse_i64,_ARR);
...
DEFINE_PRIM(_I32,__array_push_i64,_ARR _I64);
DEFINE_PRIM(_I32,__array_unshift_i64,_ARR _I64);
DEFINE_PRIM(_VOID,__array_insert_i64,_ARR _I32 _I64);
DEFINE_PRIM(_I64,__array_pop_i64,_ARR);
DEFINE_PRIM(_I64,__array_shift_i64,_ARR);
...
DEFINE_PRIM(_VOID,__array_resize_i64,_ARR _I32);
...
DEFINE_PRIM(_ABSTRACT(map_string_i64),__map_string_i64_alloc,_NO_ARG);
DEFINE_PRIM(_VOID,__map_string_i64_set,_ABSTRACT(map_string_i64) _BYTES _I64);
DEFINE_PRIM(_BOOL,__map_string_i64_exists,_ABSTRACT(map_string_i64) _BYTES);
DEFINE_PRIM(_DYN,__map_string_i64_get,_ABSTRACT(map_string_i64) _BYTES);
...
DEFINE_PRIM(_ARR,__map_string_i64_keys,_ABSTRACT(map_string_i64));
...
DEFINE_PRIM(_ARR,__map_string_i64_values,_ABSTRACT(map_string_i64));
...
DEFINE_PRIM(_BOOL,__map_string_i64_remove,_ABSTRACT(map_string_i64) _BYTES);
...
DEFINE_PRIM(_VOID,__map_string_i64_clear,_ABSTRACT(map_string_i64));
...
DEFINE_PRIM(_I32,__map_string_i64_size,_ABSTRACT(map_string_i64));
...
DEFINE_PRIM(_ABSTRACT(map_int_i64),__map_int_i64_alloc,_NO_ARG);
DEFINE_PRIM(_VOID,__map_int_i64_set,_ABSTRACT(map_int_i64) _I32 _I64);
DEFINE_PRIM(_BOOL,__map_int_i64_exists,_ABSTRACT(map_int_i64) _I32);
DEFINE_PRIM(_DYN,__map_int_i64_get,_ABSTRACT(map_int_i64) _I32);
...
DEFINE_PRIM(_ARR,__map_int_i64_keys,_ABSTRACT(map_int_i64));
...
DEFINE_PRIM(_ARR,__map_int_i64_values,_ABSTRACT(map_int_i64));
...
DEFINE_PRIM(_BOOL,__map_int_i64_remove,_ABSTRACT(map_int_i64) _I32);
...
DEFINE_PRIM(_VOID,__map_int_i64_clear,_ABSTRACT(map_int_i64));
...
DEFINE_PRIM(_I32,__map_int_i64_size,_ABSTRACT(map_int_i64));
...
DEFINE_PRIM(_I64,__int64_shl,_I64 _I32);
DEFINE_PRIM(_I64,__int64_shr,_I64 _I32);
DEFINE_PRIM(_I64,__int64_ushr,_I64 _I32);
DEFINE_PRIM(_I32,__int64_compare,_I64 _I64);
DEFINE_PRIM(_I32,__int64_unsigned_compare,_I64 _I64);
...
DEFINE_PRIM(_I32,__string_last_index_of_from,_BYTES _BYTES _I32);
...
DEFINE_PRIM(_I32,__std_int_dynamic,_DYN);
...
DEFINE_PRIM(_ABSTRACT(realtime_file_output),__sys_stdout,_NO_ARG);
DEFINE_PRIM(_ABSTRACT(realtime_file_output),__sys_stderr,_NO_ARG);
DEFINE_PRIM(_VOID,__file_output_write_string,_ABSTRACT(realtime_file_output) _BYTES);
DEFINE_PRIM(_VOID,__file_output_flush,_ABSTRACT(realtime_file_output));
...
DEFINE_PRIM(_ABSTRACT(hl_process),__process_run,_BYTES _ARR);
DEFINE_PRIM(_BYTES,__process_read_stdout,_ABSTRACT(hl_process));
DEFINE_PRIM(_BYTES,__process_read_stderr,_ABSTRACT(hl_process));
