...
DEFINE_PRIM(_ABSTRACT(realtime_jit_code),native_runtime_module_patch_code_haxe_metadata,_ABSTRACT(realtime_module) _BYTES _I32 _BYTES _I32 _BYTES _BYTES _BYTES _BYTES);
