...
DEFINE_PRIM(_ABSTRACT(realtime_module),load_code_manifest,_BYTES _ABSTRACT(realtime_bytes) _I32 _ABSTRACT(realtime_bytes) _I32 _BYTES _BYTES _I32 _I32);
...
DEFINE_PRIM(_ABSTRACT(realtime_jit_code),native_runtime_module_patch_code_haxe_metadata,_ABSTRACT(realtime_module) _ABSTRACT(realtime_bytes) _I32 _I32 _BYTES _I32 _BYTES _BYTES _BYTES _BYTES);
...
DEFINE_PRIM(_I32,native_atomic_i32_load,_BYTES);
DEFINE_PRIM(_VOID,native_atomic_i32_store,_BYTES _I32);
DEFINE_PRIM(_I32,native_atomic_i32_exchange,_BYTES _I32);
DEFINE_PRIM(_I32,native_atomic_i32_compare_exchange,_BYTES _I32 _I32);
DEFINE_PRIM(_I32,native_atomic_i32_fetch_add,_BYTES _I32);
DEFINE_PRIM(_VOID,native_atomic_fence,);
