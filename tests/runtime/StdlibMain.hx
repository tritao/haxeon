...
class StdlibMain {
	static function main():Void {
		...
		var coreSymbols:Map<String, Bool> = ["__math_is_nan" => true, "__math_pow" => true, "__reflect_compare" => true];
