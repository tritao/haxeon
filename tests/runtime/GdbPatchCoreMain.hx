...
class GdbPatchCoreMain {
	static function main():Void {
		...
		Runtime.patchSet(live,
			new PatchSet(initial.revision, generationOne.revision, generationOne.patchBytes, generationOne.changedFunctions));
		...
		Runtime.patchSet(live,
			new PatchSet(generationOne.revision, generationTwo.revision, generationTwo.patchBytes, generationTwo.changedFunctions));
