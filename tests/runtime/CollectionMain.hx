...
class CollectionMain {
	static function main():Void {
		...
		compiler.registerNative("array_int_init", "haxeon_runtime", "array_int_init", [CompilerType.TInstance(Class, "IntArray", [])], CompilerType.TVoid);
		compiler.registerNative("array_int_push", "haxeon_runtime", "array_int_push", [CompilerType.TInstance(Class, "IntArray", []), CompilerType.TInt],
			CompilerType.TVoid);
		compiler.registerNative("array_int_get", "haxeon_runtime", "array_int_get", [CompilerType.TInstance(Class, "IntArray", []), CompilerType.TInt],
			CompilerType.TInt);
