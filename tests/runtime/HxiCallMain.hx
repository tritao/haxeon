...
class HxiCallMain {
	static function main():Void {
		...
		mainSource = StringTools.replace(mainSource, "var structure = ",
			"var summed = Fixture.addPoints(start, end); var generated = Fixture.getPoint(10); var shifted = Fixture.shiftPoint(start); var outputs = generated.status == 42 && generated.point.get_x() == 10 && generated.point.get_y() == 12 && Fixture.doubleValue(21) == 42 && shifted.status == 42 && shifted.point.get_x() == 11 && shifted.point.get_y() == 12; var padded = Fixture.makePadded(40); var byValue = outputs && summed.get_x() == 30 && summed.get_y() == 32 && Fixture.checkBoxValue(box) == 42 && Fixture.checkArraysValue(arrays) == 42 && padded.get_tag() == 2 && padded.get_value() == 40; var structure = byValue && arrayFields && ");
