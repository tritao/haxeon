...
add_library(foo SHARED cxx_thunk_fixture.cpp)
...
cat > "$project_dir/foo/ffi/cxx_thunk_project.ffi.json" <<'JSON'
{
  ...
  "language": "c++",
  "header": "../native/cxx_thunk_fixture.hpp",
  "includes": ["../native"],
  "std": "c++20",
  "library": "foo",
...
echo "PASS: CMake-backed project C++ thunk generation, linking, runtime errors, caching, and invalidation"
