...
class PatchOpcodeTests {
	...
	public static function run():Void {
		var fixtures:Array<{instruction:HlInstruction, opcode:Int, operands:Array<Int>}> = [
			...
			{instruction: LoadBytes(0, 128), opcode: 4, operands: [0, 128]},
			{instruction: LoadString(0, 128), opcode: 5, operands: [0, 128]},
			{instruction: LoadNull(0), opcode: 6, operands: [0]},
			{instruction: NullCheck(0), opcode: 71, operands: [0]},
			...
			{instruction: UnsignedDiv(0, 1, 2), opcode: 11, operands: [0, 1, 2]},
			{instruction: Mod(0, 1, 2), opcode: 12, operands: [0, 1, 2]},
			{instruction: UnsignedMod(0, 1, 2), opcode: 13, operands: [0, 1, 2]},
			...
			{instruction: Negate(0, 1), opcode: 20, operands: [0, 1]},
			{instruction: BitNot(0, 1), opcode: 21, operands: [0, 1]},
			{instruction: Increment(0), opcode: 22, operands: [0, 0]},
			{instruction: Decrement(0), opcode: 23, operands: [0, 0]},
			...
			{instruction: Call3(0, 0, 1, 2, 3), opcode: 27, operands: [0, 0, 1, 2, 3]},
			{instruction: Call4(0, 0, 1, 2, 3, 4), opcode: 28, operands: [0, 0, 1, 2, 3, 4]},
			{instruction: CallN(0, 0, [1, 2, 3]), opcode: 29, operands: [0, 0, 3, 1, 2, 3]},
			{instruction: CallMethod(0, 1, [2, 3]), opcode: 30, operands: [0, 1, 2, 2, 3]},
			{instruction: ThisCall(0, 1, [2, 3]), opcode: 31, operands: [0, 1, 2, 2, 3]},
			...
			{instruction: VirtualClosure(0, 1, 128), opcode: 35, operands: [0, 1, 128]},
			...
			{instruction: JumpNotNull(0, "target"), opcode: 47, operands: [0, -2]},
			{instruction: JumpSignedLess(0, 1, "target"), opcode: 48, operands: [0, 1, -2]},
			{instruction: JumpSignedGreaterOrEqual(0, 1, "target"), opcode: 49, operands: [0, 1, -2]},
			{instruction: JumpSignedGreater(0, 1, "target"), opcode: 50, operands: [0, 1, -2]},
			...
			{instruction: JumpUnsignedGreaterOrEqual(0, 1, "target"), opcode: 53, operands: [0, 1, -2]},
			{instruction: JumpNotLess(0, 1, "target"), opcode: 54, operands: [0, 1, -2]},
			{instruction: JumpNotGreater(0, 1, "target"), opcode: 55, operands: [0, 1, -2]},
			{instruction: JumpEqual(0, 1, "target"), opcode: 56, operands: [0, 1, -2]},
			{instruction: JumpNotEqual(0, 1, "target"), opcode: 57, operands: [0, 1, -2]},
			...
			{instruction: ToUFloat(0, 1), opcode: 61, operands: [0, 1]},
			{instruction: ToInt(0, 1), opcode: 62, operands: [0, 1]},
			{instruction: SafeCast(0, 1), opcode: 63, operands: [0, 1]},
			{instruction: UnsafeCast(0, 1), opcode: 64, operands: [0, 1]},
			...
			{instruction: GetI8(0, 1, 2), opcode: 74, operands: [0, 1, 2]},
			{instruction: GetI16(0, 1, 2), opcode: 75, operands: [0, 1, 2]},
			{instruction: GetMem(0, 1, 2), opcode: 76, operands: [0, 1, 2]},
			{instruction: ArrayGet(0, 1, 2), opcode: 77, operands: [0, 1, 2]},
			{instruction: SetI8(0, 1, 2), opcode: 78, operands: [0, 1, 2]},
			{instruction: SetI16(0, 1, 2), opcode: 79, operands: [0, 1, 2]},
			{instruction: SetMem(0, 1, 2), opcode: 80, operands: [0, 1, 2]},
			...
			{instruction: GetType(0, 1), opcode: 85, operands: [0, 1]},
			{instruction: GetTID(0, 1), opcode: 86, operands: [0, 1]},
			{instruction: Ref(0, 1), opcode: 87, operands: [0, 1]},
			{instruction: Unref(0, 1), opcode: 88, operands: [0, 1]},
			{instruction: SetRef(0, 1), opcode: 89, operands: [0, 1]},
			{instruction: MakeEnum(0, 1, [2, 3]), opcode: 90, operands: [0, 1, 2, 2, 3]},
			{instruction: EnumAlloc(0, 1), opcode: 91, operands: [0, 1]},
			{instruction: EnumIndex(0, 1), opcode: 92, operands: [0, 1]},
			{instruction: EnumField(0, 1, 2, 3), opcode: 93, operands: [0, 1, 2, 3]},
			{instruction: SetEnumField(0, 128, 1), opcode: 94, operands: [0, 128, 1]},
			{instruction: Assert, opcode: 95, operands: []},
			{instruction: RefData(0, 1), opcode: 96, operands: [0, 1]},
			{instruction: RefOffset(0, 1, 2), opcode: 97, operands: [0, 1, 2]},
			{instruction: Nop, opcode: 98, operands: []},
			{instruction: Prefetch(0, 128, 256), opcode: 99, operands: [0, 128, 256]},
			{instruction: Asm(128, 256, 512), opcode: 100, operands: [128, 256, 512]},
			{instruction: Catch(128), opcode: 101, operands: [128]},
