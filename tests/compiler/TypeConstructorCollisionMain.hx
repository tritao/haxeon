...
class TypeConstructorCollisionMain {
	static function main():Void {
		...
		compiler.update("nativekit/ui/core/DockNode.hx",
			"package nativekit.ui.core; enum DockNode { Empty; Tabs(ids:Array<String>, active:String); " + "Split(first:DockNode, second:DockNode); }");
		compiler.update("nativekit/ui/widgets/Tabs.hx", "package nativekit.ui.widgets; class Tabs { public function new() {} }");
		...
		compiler.update("Main.hx",
			"import nativekit.ui.core.DockNode; import nativekit.ui.widgets.Tabs; " + "import nativekit.ui.widgets.Workspace; function main():Void { " +
