...
function html(webview: vscode.Webview): string {
  ...
  <div class="toolbar"><button data-command="connect">Connect</button><button data-command="start">Start</button><button data-command="pause">Pause</button><button data-command="reset">Reset</button><button id="capture">Record</button><button id="openCapture">Open</button><button id="compareCapture">Compare</button><button data-export="folded">Export folded</button><button data-export="perfetto">Export Perfetto</button><input id="rate" type="number" min="1" max="100000" value="250"><label>range ms <input id="startMs" type="number" min="0" value="0"></label><label>to <input id="endMs" type="number" min="0" value="9007199254740991"></label><select id="revision"><option value="all">All revisions</option></select></div>
