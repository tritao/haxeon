...
| `Sys.hx` | `std/Sys.hx` | Limited to the currently supported process, environment, filesystem, console, and command operations; signatures retain the existing runtime ABI and use source-declared HashLink bindings. |
