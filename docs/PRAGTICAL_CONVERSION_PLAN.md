...
1. finish collection ownership and mutable capture cells;
2. add the representative multi-module plugin fixture;
3. integrate structural reload/state migration with that fixture;
