...
class HaxeonProjectBuild {
	public static function build(project:ResolvedProject, home:String, output:String, defines:Array<String>, jobs:Int, planOnly:Bool,
		explain:Bool, timingsEnabled:Bool, resolutionMs:Float):Int {
