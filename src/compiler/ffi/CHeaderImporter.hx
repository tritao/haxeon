...
class CHeaderImporter {
	public static function importHeader(header:String, target:String, includes:Array<String>, clang:String = "clang"):String {
		...
		output.add('interface ${moduleName(header)} @target("$target") {\n');
