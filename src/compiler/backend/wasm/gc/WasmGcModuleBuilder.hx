	...
	static function isSupportedGcRuntimeNative(name:String):Bool {
		...
		return switch name {
			case "__array_alloc_i32", "__array_alloc_i64", "__array_alloc_bool", "__array_alloc_f64", "__array_alloc_bytes", "__array_alloc_ref",
				...
				"__bytes_get", "__bytes_set", "__bytes_blit", "__bytes_get_i32", "__bytes_get_float", "__bytes_get_double", "__bytes_set_i32",
				"__bytes_set_float", "getI32", "setI32", "getI64", "setI64", "getF32", "setF32", "getF64", "setF64", "__bytes_view", "__bytes_sub",
				"__bytes_compare", "__bytes_to_string", "__bytes_get_string", "structCopy", "structCopyPointer", "structSetBorrowedBytes", "structUtf8Copy",
				"structSetUtf8", "structSlice", "structWithRoots", "structGetRoots", "__bytes_input_new", "__bytes_input_position",
