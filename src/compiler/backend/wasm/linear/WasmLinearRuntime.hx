...
class WasmLinearRuntime {
		...
		for (native in program.natives)
			if (used.exists(native.name))
				switch native.symbol {
					case "__math_is_finite", "__math_pow", "__math_cos", "__math_sin", "__math_tan", "__math_sqrt", "__math_atan2", "__math_fmod", "__math_round", "__math_ceil",
	...
	static function addRuntimeNativeFunction(module:WasmModule, native:compiler.ir.Ir.IrNative, allocator:Int, bytesDataPointer:Int,
		...
		return switch native.symbol {
			case "__math_is_finite", "__math_pow", "__math_cos", "__math_sin", "__math_tan", "__math_sqrt", "__math_atan2", "__math_fmod", "__math_round", "__math_ceil", "__math_floor",
