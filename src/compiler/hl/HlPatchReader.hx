...
class HlPatchReader {
    public static function decode(bytes:Bytes):HlPatch {
        ...
        try {
            ...
            return {moduleId:moduleId,baseRevision:base,revision:revision,baseInts:baseInts,baseFloats:baseFloats,baseStrings:baseStrings,baseTypes:baseTypes,ints:ints,floats:floats,strings:strings,types:types,functions:functions};
    ...
    static function readFunction(input:BytesInput):HlPatchFunction {
        ...
        return {type:type,functionIndex:stableId,registers:registers,instructions:instructions};
    }
