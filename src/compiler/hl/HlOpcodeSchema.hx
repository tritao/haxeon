	...
	public static function arity(opcode:Int):Int
		return switch opcode {
			...
			case HlOpcode.Mov, HlOpcode.Int, HlOpcode.Float, HlOpcode.Bool, HlOpcode.Bytes, HlOpcode.String, HlOpcode.StaticClosure, HlOpcode.GetGlobal,
				...
				HlOpcode.ArraySize, HlOpcode.Type, HlOpcode.JTrue, HlOpcode.JFalse, HlOpcode.JNull, HlOpcode.JNotNull, HlOpcode.Call0, HlOpcode.EnumAlloc,
				HlOpcode.EnumIndex: 2;
			case HlOpcode.Add, HlOpcode.Sub, HlOpcode.Mul, HlOpcode.SDiv, HlOpcode.UDiv, HlOpcode.SMod, HlOpcode.UMod, HlOpcode.Shl, HlOpcode.SShr,
				...
				HlOpcode.SetField, HlOpcode.GetArray, HlOpcode.SetArray, HlOpcode.GetI8, HlOpcode.GetI16, HlOpcode.GetMem, HlOpcode.SetI8, HlOpcode.SetI16,
				HlOpcode.SetMem, HlOpcode.JSLt, HlOpcode.JSGte, HlOpcode.JSGt, HlOpcode.JSLte, HlOpcode.JULt, HlOpcode.JUGte, HlOpcode.JNotLt,
				HlOpcode.JNotGte, HlOpcode.JEq, HlOpcode.JNotEq: 3;
