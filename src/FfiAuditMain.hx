...
class FfiAuditMain {
	static function main():Void {
		var targets:Array<String> = [], includes:Array<String> = [], paths:Array<String> = [], format = "text", profile:Null<String> = null,
			...
			dependencies:Array<String> = [], excludedHeaders:Array<String> = [], dependencyPaths:Array<String> = [];
		for (argument in Sys.args())
			...
			else if (StringTools.startsWith(argument, "--depends=")) dependencies.push(argument.substring(10));
			else if (StringTools.startsWith(argument, "--dependency-hxi=")) dependencyPaths.push(argument.substring(17));
